...
*
*----------------------------------------------------------------------*
CLASS lcl_test DEFINITION FINAL FRIENDS zeveredge_json.
...
*
*----------------------------------------------------------------------*
CLASS lc_json_custom DEFINITION FINAL INHERITING FROM zeveredge_json.
  PUBLIC SECTION.
    CLASS-METHODS:
...
CLASS abap_unit_testclass IMPLEMENTATION.
  ...
  METHOD serialize_numbers.
    ...
    lv_act = zeveredge_json=>serialize( data = ls_data ).

    cl_aunit_assert=>assert_equals( act = lv_act exp = lv_exp msg = 'Serialization of numeric types fails' ).

    zeveredge_json=>deserialize( EXPORTING json = lv_act CHANGING data = ls_data2 ).
    ...
    lv_act = zeveredge_json=>serialize( data = ls_data numc_as_string = abap_true ).

    cl_aunit_assert=>assert_equals( act = lv_act exp = lv_exp msg = 'Serialization of numeric types fails' ).

    lv_exp = '{"negative_i":-1,"positive_i":10000,"positive_n":1,"negative_f":-1.7976931348623158E+30,"positive_b":255,"negative_s":-32768,"negative_p":-2343.342454332245,"quan":10000000.000}'.
    lv_act = zeveredge_json=>serialize( data = ls_data pretty_name = zeveredge_json=>pretty_mode-low_case ).
  ...
  METHOD serialize_booleans.
    ...
    TYPES:
      BEGIN OF t_data,
        ...
        x_bool_true         TYPE zeveredge_json=>bool,
        x_bool_false        TYPE zeveredge_json=>bool,
        x_tribool_true      TYPE zeveredge_json=>tribool,
        x_tribool_false     TYPE zeveredge_json=>tribool,
        x_tribool_undefined TYPE zeveredge_json=>tribool,
      END OF t_data.
    ...
    ls_data-tribool_true        = zeveredge_json=>c_tribool-true.
    ls_data-tribool_false       = zeveredge_json=>c_tribool-false.
    ls_data-tribool_undefined   = zeveredge_json=>c_tribool-undefined.
    ls_data-x_bool_true         = zeveredge_json=>c_bool-true.
    ls_data-x_bool_false        = zeveredge_json=>c_bool-false.
    ls_data-x_tribool_true      = zeveredge_json=>c_tribool-true.
    ls_data-x_tribool_false     = zeveredge_json=>c_tribool-false.
    ls_data-x_tribool_undefined = zeveredge_json=>c_tribool-undefined.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_act CHANGING data = ls_act ).
    ...
    lv_act = zeveredge_json=>serialize( data = ls_data compress = abap_true ).
  ...
  METHOD serialize_types.
    ...
    lv_act    = zeveredge_json=>serialize( data = ls_data hex_as_base64 = abap_false ).

    cl_aunit_assert=>assert_equals( act = lv_act exp = lv_exp msg = 'Serialization of hex without base64 fails' ).

    zeveredge_json=>deserialize( EXPORTING json = lv_act hex_as_base64 = abap_false CHANGING data = ls_data2 ).
    ...
    CONCATENATE `{"FLAG":true,"CHAR":"\"TEST\\\"/C:\\temp","NUMC":12345678,"STRING":"ABCDEFG","XSTRING":"q83v","INTEGER":42,"FLOAT":3.1415926535897900E+00,`
                ...
                INTO lv_exp.
    lv_act    = zeveredge_json=>serialize( ts_as_iso8601 = abap_true data = ls_data ).
  ...
  METHOD serialize_associative_array.
    ...
    lv_act = zeveredge_json=>serialize( data = lt_table1 pretty_name = zeveredge_json=>pretty_mode-camel_case assoc_arrays = abap_true ).
    cl_aunit_assert=>assert_equals( act = lv_act exp = lv_exp msg = 'Serialization of standard fails' ).

    lv_exp = '[{"key1":"k100","key2":0,"value1":"v100"},{"key1":"k101","key2":1,"value1":"v101"},{"key1":"k102","key2":2,"value1":"v102"}]'.
    lv_act = zeveredge_json=>serialize( data = lt_table2 pretty_name = zeveredge_json=>pretty_mode-camel_case assoc_arrays = abap_true ).
    ...
    lv_act = zeveredge_json=>serialize( data = lt_table3 pretty_name = zeveredge_json=>pretty_mode-camel_case assoc_arrays = abap_true ).
    cl_aunit_assert=>assert_equals( act = lv_act exp = lv_exp msg = 'Serialization of sorted table with unique fails' ).

    lv_exp = '{"k100":{"key2":0,"value1":"v100"},"k101":{"key2":1,"value1":"v101"},"k102":{"key2":2,"value1":"v102"}}'.
    lv_act = zeveredge_json=>serialize( data = lt_table4 pretty_name = zeveredge_json=>pretty_mode-camel_case assoc_arrays = abap_true ).
    ...
    lv_act = zeveredge_json=>serialize( data = lt_table5 pretty_name = zeveredge_json=>pretty_mode-camel_case assoc_arrays = abap_true ).
    ...
    lv_act = zeveredge_json=>serialize( data = lt_table6 pretty_name = zeveredge_json=>pretty_mode-camel_case assoc_arrays = abap_true ).
    ...
    CONCATENATE '{' crlf
                 ...
                 '}'
                 INTO lv_exp.
    lv_act = zeveredge_json=>serialize( data = lt_table6 pretty_name = zeveredge_json=>pretty_mode-camel_case assoc_arrays = abap_true format_output = abap_true ).
    ...
    lv_act = zeveredge_json=>serialize( data = ls_data compress = abap_true assoc_arrays = abap_true assoc_arrays_opt = abap_true ).
    ...
    CONCATENATE '{' crlf
                 ...
                 '}'
                 INTO lv_exp.
    lv_act = zeveredge_json=>serialize( data = ls_data compress = abap_true assoc_arrays = abap_true assoc_arrays_opt = abap_true format_output = abap_true ).
  ...
  METHOD serialize_form_factor.
    ...
    lv_act = zeveredge_json=>serialize( data = ls_data pretty_name = zeveredge_json=>pretty_mode-camel_case ).
    ...
    lv_act = zeveredge_json=>serialize( data = ls_data pretty_name = zeveredge_json=>pretty_mode-camel_case compress = abap_true ).
    ...
    lv_act = zeveredge_json=>serialize( data = ls_data pretty_name = abap_false compress = abap_true ).
  ...
  METHOD serialize_table.
    ...
    ls_data-ff-tablet   = zeveredge_json=>c_tribool-true.
    ls_data-ff-phone    = abap_false.
    ls_data-desktop     = abap_true.
    ls_data-tablet      = zeveredge_json=>c_tribool-false.
    ...
    lv_act = zeveredge_json=>serialize( data = lt_data pretty_name = zeveredge_json=>pretty_mode-camel_case ).
  ...
  METHOD serialize_ref.
    ...
    lv_act = zeveredge_json=>serialize( data = lt_data ).
...
*
*    DATA:  ls_data TYPE t_data,
*           lv_act  TYPE ZEVEREDGE_JSON=>json,
*           ls_act  LIKE ls_data,
*           lv_exp  LIKE lv_act.
*
...
*    cl_aunit_assert=>assert_equals( act = ls_act exp = ls_data msg = 'Deserialization of enumerations fails' ).
  ...
  METHOD serialize_upper_camel_case.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_act pretty_name = zeveredge_json=>pretty_mode-camel_case CHANGING data = ls_act ).
  ...
  METHOD deserialize_camel_case.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_json pretty_name = zeveredge_json=>pretty_mode-camel_case CHANGING data = ls_act ).
  ...
  METHOD deserialize_ref.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_data CHANGING data = lt_act ).
  ...
  METHOD deserialize_form_factor.
    ...
    zeveredge_json=>deserialize( EXPORTING json = json pretty_name = zeveredge_json=>pretty_mode-camel_case CHANGING data = lv_act ).
  ...
  METHOD deserialize_malformed.
    ...
    TRY .
        ...
        zeveredge_json=>deserialize( EXPORTING json = json CHANGING data = lv_act ).
    ...
    zeveredge_json=>deserialize( EXPORTING json = json CHANGING data = user ).
    ...
    CLEAR: user.
    zeveredge_json=>deserialize( EXPORTING json = `INVALID_JSON` CHANGING data = user ).
    cl_aunit_assert=>assert_initial( act = user msg = 'Deserialization of invalid JSON fails' ).

    DATA: lr_data TYPE REF TO data.
    lr_data = zeveredge_json=>generate( json = `INVALID_JSON` ).
  ...
  METHOD deserialize_non_fitting_table.
    ...
    zeveredge_json=>deserialize( EXPORTING json = json CHANGING data = itab ).
  ...
  METHOD deserialize_target_mapping.
    ...
    zeveredge_json=>deserialize( EXPORTING json = json pretty_name = zeveredge_json=>pretty_mode-camel_case CHANGING data = lv_temp ).
    zeveredge_json=>deserialize( EXPORTING json = lv_temp-tile_configuration pretty_name = zeveredge_json=>pretty_mode-camel_case CHANGING data = lv_act ).
...
**********************************************************************
  ...
  METHOD deserialize_array.
    ...
    zeveredge_json=>deserialize( EXPORTING json = json CHANGING data = lt_act ).
  ...
  METHOD deserialize_types.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_data pretty_name = zeveredge_json=>pretty_mode-low_case CHANGING data = lv_act ).
...
**********************************************************************
  ...
  METHOD deserialize_dynamic_tile.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_data CHANGING data = lv_act ).
  ...
  METHOD deserialize_associative_array.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_data assoc_arrays = abap_true CHANGING data = lt_act ).
  ...
  METHOD deserialize_empty_structure.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_data pretty_name = zeveredge_json=>pretty_mode-camel_case CHANGING data = lt_act ).
  ...
  METHOD serialize_object.
    ...
    lv_act = zeveredge_json=>serialize( data = lo_data ).
    ...
    CONCATENATE '{' crlf
             ...
             '}'
             INTO lv_exp.
    lv_act = zeveredge_json=>serialize( data = lo_data format_output = abap_true ).
  ...
  METHOD deserialize_object.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_data CHANGING data =  lo_data ).
  ...
  METHOD deserialize_partial.
    ...
    TYPES: BEGIN OF ts_record,
             id        TYPE string,
             m_columns TYPE zeveredge_json=>json,
           END OF ts_record.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_json assoc_arrays = abap_true pretty_name = zeveredge_json=>pretty_mode-camel_case CHANGING data = lt_act ).
  ...
  METHOD serialize_partial.
    ...
    DATA: lv_exp TYPE zeveredge_json=>json,
          lv_act TYPE zeveredge_json=>json,
          lt_act TYPE SORTED TABLE OF ts_record WITH UNIQUE KEY id,
          ls_act LIKE LINE OF lt_act.
    ...
    lv_act = zeveredge_json=>serialize( data = lt_act assoc_arrays = abap_true pretty_name = zeveredge_json=>pretty_mode-camel_case ).
  ...
  METHOD custom_compressible.
    ...
    DATA: ls_data            TYPE tp_s_data,
          lo_json            TYPE REF TO zeveredge_json,
  ...
  METHOD custom_pretty_name2.
    ...
    DATA: ls_exp     TYPE tp_s_data,
          ...
          lt_mapping TYPE zeveredge_json=>name_mappings,
...
*    ).
    ...
    CREATE OBJECT lo_json
      EXPORTING
        pretty_name      = zeveredge_json=>pretty_mode-low_case
  ...
  METHOD extended_pretty_name.
    ...
    lv_json = zeveredge_json=>serialize( data = ls_exp pretty_name = zeveredge_json=>pretty_mode-extended ).

    cl_aunit_assert=>assert_equals( act = lv_json exp = lv_exp msg = 'Extended pretty name fails!' ).

    zeveredge_json=>deserialize( EXPORTING json = lv_json pretty_name = zeveredge_json=>pretty_mode-extended CHANGING data = ls_act ).
  ...
  METHOD deserialize_alias_type.
    ...
    DATA: ls_act  TYPE lty_object,
          ls_exp  LIKE ls_act,
          lv_json TYPE zeveredge_json=>json.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_json pretty_name = zeveredge_json=>pretty_mode-camel_case
  ...
  METHOD name_value_map.
    ...
    lv_act = zeveredge_json=>serialize( data = lt_exp assoc_arrays = abap_true assoc_arrays_opt = abap_true ).
    cl_aunit_assert=>assert_equals( act = lv_act exp = lv_exp msg = 'Name/Value map serialization fails!' ).

    zeveredge_json=>deserialize( EXPORTING json = lv_act assoc_arrays = abap_true assoc_arrays_opt = abap_true
    ...
    lv_act = zeveredge_json=>serialize( data = lt_exp2 assoc_arrays = abap_true assoc_arrays_opt = abap_true ).
    cl_aunit_assert=>assert_equals( act = lv_act exp = lv_exp msg = 'Name/Value map serialization fails!' ).
  ...
  METHOD dynamic_types.
    ...
    ls_exp-data      = zeveredge_json=>serialize( data = lt_flight compress = abap_true pretty_name = zeveredge_json=>pretty_mode-camel_case ).
    lo_typedescr     = cl_abap_typedescr=>describe_by_data( lt_flight ).
    ls_exp-abap_type = lo_typedescr->absolute_name.
    lv_json          = zeveredge_json=>serialize( data = ls_exp compress = abap_true pretty_name = zeveredge_json=>pretty_mode-camel_case ).
    ...
    zeveredge_json=>deserialize( EXPORTING json = ls_act-data pretty_name = zeveredge_json=>pretty_mode-camel_case CHANGING data = <data> ).
  ...
  METHOD deserialize_malformed_type.
    ...
    DATA: lv_json       TYPE zeveredge_json=>json,
    ...
    zeveredge_json=>deserialize( EXPORTING json         = lv_json
                                         pretty_name  = zeveredge_json=>pretty_mode-camel_case
    ...
    DATA: lo_json TYPE REF TO zeveredge_json.
  ...
  METHOD serialize_dynamic_type.
    ...
    DATA:
      ...
      lv_act          TYPE zeveredge_json=>json,
      lv_exp          TYPE zeveredge_json=>json.
    ...
    lv_act = zeveredge_json=>serialize( data = lr_table pretty_name = zeveredge_json=>pretty_mode-camel_case ).
  ...
  METHOD deserialze_to_read_only.
    ...
    lv_json = zeveredge_json=>serialize( lo_exp ).
    zeveredge_json=>deserialize( EXPORTING json = lv_json CHANGING data = lo_exp ).
  ...
  METHOD generate.
    ...
    lr_act = zeveredge_json=>generate( json = lv_json pretty_name = zeveredge_json=>pretty_mode-camel_case ).
    ...
    lr_act = zeveredge_json=>generate( json = lv_json ).
  ...
  METHOD deserialize_odata.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_json pretty_name = zeveredge_json=>pretty_mode-camel_case CHANGING data = ls_odata_response ).
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_json pretty_name = zeveredge_json=>pretty_mode-camel_case CHANGING data = ls_odata_response2 ).
  ...
  METHOD initialize_on_deserialize.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_json pretty_name = zeveredge_json=>pretty_mode-camel_case CHANGING data = ls_data ).
  ...
  METHOD deserialize_ref_to_data.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_json pretty_name = zeveredge_json=>pretty_mode-camel_case assoc_arrays = abap_true assoc_arrays_opt = abap_true CHANGING data = ls_data ).
    cl_aunit_assert=>assert_bound( act = ls_data-struct msg = 'Deserialize to unknown REF TO data for struct fails!' ).
  ...
  METHOD conversion_exits.
    ...
    lv_json = zeveredge_json=>serialize( data = ls_exp ).
    ...
    lv_json = zeveredge_json=>serialize( data = ls_exp conversion_exits = abap_true ).

    FIND FIRST OCCURRENCE OF lv_date_x IN lv_json.
    cl_aunit_assert=>assert_subrc( act = sy-subrc msg = 'Conversion exit into external format fails!' ).

    zeveredge_json=>deserialize( EXPORTING json = lv_json conversion_exits = abap_true CHANGING data = ls_act ).
    ...
    lv_json = zeveredge_json=>serialize( data = lt_act conversion_exits = abap_true ).
  ...
  METHOD generate_special_attr_names.
    ...
    lr_data = zeveredge_json=>generate( json = lv_json ).
  ...
  METHOD escape_and_unescape.
    ...
    zeveredge_json=>deserialize( EXPORTING json = lv_json CHANGING data = ls_data ).
  ...
  METHOD serialize_formatted.
    ...
    " serialize table lt_flight into JSON, skipping initial fields and converting ABAP field names into camelCase
    lv_json      = zeveredge_json=>serialize( data = lt_fligt_exp compress = abap_true pretty_name = zeveredge_json=>pretty_mode-camel_case format_output = abap_true ).
    cl_aunit_assert=>assert_not_initial( act = lv_json msg = 'Serialization with formatting fails!' ).

    zeveredge_json=>deserialize( EXPORTING json = lv_json pretty_name = zeveredge_json=>pretty_mode-camel_case CHANGING data = lt_fligt_act ).
